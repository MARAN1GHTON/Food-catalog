...
var dummyMeals = [
  ...
  Meal(
    ...
    complexity: Complexity.challenging,
    imageUrl:
        'https://www.allrecipes.com/thmb/4xmE8lu1TSg893xk93wk20AKJcs=/0x512/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/46822-indian-chicken-curry-ii-DDMFS-4x3-39160aaa95674ee395b9d4609e3b0988.jpg',
    duration: 35,
    ingredients: [
      '4 Chicken Breasts',
      '1 Onion',
  ...
  Meal(
    ...
    complexity: Complexity.hard,
    imageUrl:
        'https://www.marthastewart.com/thmb/kZWxe8K1f3lUftGOhpP9dv0Tv7U=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/MSL-868486-Chocolate-Souffle-Hero-horiz-0823-751722da28324edb9b98beead3502506.jpg',
    duration: 45,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://klcode-images.imgix.net/zSuDvvrPSD9P7meesMOK_Cherry-Tomato-Asparagus.jpg?h=450&w=700&fit=crop&bg=FFFFFF',
    duration: 30,
    ingredients: [
